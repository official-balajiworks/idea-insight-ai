...
import { Lightbulb, ArrowRight, Mail, Lock, User } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Welcome to IdeaAnalyzer.',
      });
      navigate('/dashboard');
    } catch (error) {
      toast({
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          ...
          <h1 className="text-4xl xl:text-5xl font-bold text-primary-foreground mb-6 leading-tight">
            Turn Ideas Into<br />Validated<br />Opportunities
          </h1>
          <p className="text-primary-foreground/80 text-lg max-w-md">
            Join thousands of entrepreneurs who trust our AI to validate their startup concepts before investing time and resources.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <p className="text-muted-foreground mb-8">
            Start analyzing your startup ideas today
          </p>
          ...
          <Button
            ...
            onClick={() => {
              toast({
                ...
                description: 'Connect a backend to enable Google authentication.',
              });
            }}
          >
